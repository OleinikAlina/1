...
public class FigureL extends Figure{
    public FigureL(){
        blocks.add(new Block(6,0, Color.decode("#a8dfff")));
        blocks.add(new Block(6,1, Color.decode("#a8dfff")));
        blocks.add(new Block(5,1, Color.decode("#a8dfff")));
        blocks.add(new Block(4,1, Color.decode("#a8dfff")));
    }
