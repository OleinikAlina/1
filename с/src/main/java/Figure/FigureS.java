...
public class FigureS extends Figure{
    public FigureS(){
        blocks.add(new Block(4,1, Color.decode("#b2ffa8")));
        blocks.add(new Block(5,1, Color.decode("#b2ffa8")));
        blocks.add(new Block(5,0, Color.decode("#b2ffa8")));
        blocks.add(new Block(6,0, Color.decode("#b2ffa8")));
    }
